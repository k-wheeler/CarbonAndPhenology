...
combinations <- as.data.frame(rbind(
  c('Tair_D',TRUE,FALSE,FALSE),
  c('Tair_D',FALSE,TRUE,FALSE),
  c('Tair_D',FALSE,FALSE,FALSE),
  c('TairOnly',TRUE,FALSE,FALSE),
  c('TairOnly',FALSE,TRUE,FALSE),
  c('TairOnly',FALSE,FALSE,FALSE),
  c('NPP',TRUE,FALSE,FALSE),
  c('NPP',FALSE,TRUE,FALSE),
  c('NPP',FALSE,FALSE,FALSE),
  c('NPP',TRUE,FALSE,TRUE),
  c('NPP',FALSE,TRUE,TRUE),
  c('NPP',FALSE,FALSE,TRUE),
  c('GPP',TRUE,FALSE,FALSE),
  c('GPP',FALSE,TRUE,FALSE),
  c('GPP',FALSE,FALSE,FALSE),
  c('GPP',TRUE,FALSE,TRUE),
  c('GPP',FALSE,TRUE,TRUE),
